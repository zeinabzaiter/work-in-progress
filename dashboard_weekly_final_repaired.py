...
fig2.update_layout(xaxis_title="Semaine", yaxis_title="Prévalence (%)", hovermode="x unified")
...
fig_abx.update_layout(xaxis_title="Mois", yaxis_title="% Résistance", hovermode="x unified")
